...
import cn.way.material_dialogs.internal.MDAdapter;
import cn.way.material_dialogs.internal.MDButton;
...
import cn.way.material_progressbar.HorizontalProgressDrawable;
import cn.way.material_progressbar.IndeterminateCircularProgressDrawable;
import cn.way.material_progressbar.IndeterminateHorizontalProgressDrawable;

/**
 * <pre>
 *     author: Way Lin
 *     date  : 2018.02.03
 *     desc  : Used by MaterialDialog while initializing the dialog. Offloads some of the code to make the main
...
class DialogInit {
    ...
    static void init(final MaterialDialog dialog) {
        ...
        dialog.positiveButton.setStackedBackground(dialog.getButtonSelector(DialogAction.POSITIVE, true));
        dialog.positiveButton.setDefaultBackground(
        ...
        dialog.negativeButton.setStackedBackground(dialog.getButtonSelector(DialogAction.NEGATIVE, true));
        dialog.negativeButton.setDefaultBackground(
        ...
        dialog.neutralButton.setStackedBackground(dialog.getButtonSelector(DialogAction.NEUTRAL, true));
        dialog.neutralButton.setDefaultBackground(dialog.getButtonSelector(DialogAction.NEUTRAL, false));
