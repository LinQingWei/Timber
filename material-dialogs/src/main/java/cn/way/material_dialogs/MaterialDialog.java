...
import cn.way.material_dialogs.util.RippleHelper;
import cn.way.material_dialogs.util.TypefaceHelper;
...
public class MaterialDialog extends DialogBase implements View.OnClickListener, DefaultRvAdapter.InternalListCallback {
    ...
    enum ListType {
        ...
        public static int getLayoutForType(ListType type) {
            switch (type) {
                case REGULAR:
                    return R.layout.md_list_item;
                case SINGLE:
                    return R.layout.md_list_item_single_choice;
                case MULTI:
                    return R.layout.md_list_item_multi_choice;
                default:
